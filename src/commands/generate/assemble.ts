...
//
// In an ESM project ("type": "module" with nodenext resolution — what
// \`@nestjs/cli@12\` scaffolds) the import carries the \`.js\` suffix:
// \`import "./arkveil.generated.js"\`. That spelling resolves in CommonJS
// projects too, so it is safe to use everywhere.`;
